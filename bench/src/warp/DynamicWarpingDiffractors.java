 ...
 * @version 2012.07.05
 */
public class DynamicWarpingDiffractors {
   ...
   */
  public DynamicWarpingDiffractors(int shiftMin, int shiftMax) {
   ...
   *  of shifts.
   */
  public DynamicWarpingDiffractors(int shiftMin, int shiftMax, int fr) {
   ...
   * @param u output array of shifts u.
   * @param bdir backtrack direction. Negative for reverse,
   *  positive for forward.
   */
  public void findShifts(
      float[][] f, float[][] g, float[][] u, int bdir)
  {
  ...
  public void backtrackReverse(float[][] d, float[][] e, float[] u) {
    backtrack(-1,_bstrain1,0.0f,_shifts,d,e,u);
  }
  ...
  public void backtrackReverse2(float[][][] d, float[][][] e, float[][] u) {
    ...
    for (int i1=0; i1<n1; ++i1) {
      ...
      backtrack(-1,_bstrain2,0.0f,_shifts,di1,ei1,ui1);
      for (int i2=0; i2<n2; ++i2)
        u[i2][i1] = ui1[i2];
    }
  }
  ...
  private static void backtrack(
    int dir, int b, float fl, Sampling shifts,
